...
typedef NS_OPTIONS(NSUInteger, UMSocialPlatformFeature)
{
    ...
    //SSOShare
    UMSocialPlatformFeature_IsCanShare_Text                     ,
    UMSocialPlatformFeature_IsCanShare_Image                    ,
    UMSocialPlatformFeature_IsCanShare_Media                    ,
    UMSocialPlatformFeature_IsCanShare_TextAndImage             ,
    UMSocialPlatformFeature_IsCanShare_TextAndMedia             ,
