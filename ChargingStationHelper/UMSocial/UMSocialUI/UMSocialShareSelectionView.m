...
{
    self.selectionPlatform =(UMSocialPlatformType) [[self.sharePaltformNames[indexPath.row] valueForKey:UMSSharePlatformTypeKey] integerValue];
...
{
    UMSocialPlatformType platformType_int =(UMSocialPlatformType) [platformType integerValue];
